...
- Runtime dependencies are loaded from CDNs inside `index.html`: Tailwind (`cdn.tailwindcss.com`), Chart.js (`cdn.jsdelivr.net`), and the Inter font (`fonts.googleapis.com`). Do not assume `npm install` or a bundler exists.
